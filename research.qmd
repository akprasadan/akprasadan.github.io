...
This page summarizes some of the recent research I worked on during my PhD with my advisor [Matey Neykov](https://mateyneykov.com/), and continue to on the side as I transition toward my postdoctoral research. A full list of the resulting publications can be found on my [Publications page](publications.qmd).
...
I used this work to satisfy our PhD program's requirement of completing an "Advanced Data Analysis" project. I worked with [Joel Greenhouse](https://www.stat.cmu.edu/~joel/) at CMU as well as a team of statisticians at Novartis for about 2 years. I also presented some of our work on joint models at the 2023 Joint Statistical Meetings in Toronto, and I am currently preparing a publication of this work with the same group.
