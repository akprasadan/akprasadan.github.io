...
This won't be a tutorial in `ggplot` like my previous posts, but I will use it to show off my `ggplot` skills nonetheless. The code is also included at the end to generate each figure (and input data can be found on my GitHub repository). Moreover, I am not very familiar with cars, so a lot of my conclusions are speculative in nature. I'm sure I will make some embarrasing errors with auto technology, if I have not already above.
