...
Moreover, I still do not fully understand the best way to fine-tune margins of the various plot objects, since practically every `theme` argument has its own margin argument. So the spacing certainly doesn't math the original. At a certain point, I basically gave up out of frustration. 
